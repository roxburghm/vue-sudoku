<template>
    <v-card>
        ...
        <v-card-text>
            ...
            <v-divider class="my-4"/>
            <p class="grey--text font-weight-light">Contact author via <span class="secondary--text">matt<v-icon small color="secondary">mdi-at</v-icon>roxburghm.com</span> if you find any problems.</p>
